        ...
        angular.forEach([kendo.ui, kendo.dataviz && kendo.dataviz.ui], function (namespace)
        {
            angular.forEach(namespace, function (value, key)
            {
                ...
                if (key.match(/^[A-Z]/) && key !== 'Widget') {
                    ...
                    if (key == 'StockChart') {
                        console.log("*** Widget kendoStockChart geladen!");
                    }
                }
            });
        });
...
angular.module('kendo.directives').factory('widgetFactory', [
    '$parse', '$log', function ($parse, $log)
    {
        ...
        {
            console.log("KENDO create widget");
...
angular.module('kendo.directives').factory('directiveFactory', [
    'widgetFactory', '$timeout', '$parse', function (widgetFactory, $timeout, $parse)
    {
        ...
        {
            console.log("widgetFactory.create(" + kendoWidget + ")");
            return {
                ...
                scope: false,
                controller: [
                    '$scope', '$attrs', '$element', '$transclude', function ($scope, $attrs, $element, $transclude)
                    {
...
(function (angular)
{
    ...
    angular.forEach(widgets, function (widget)
    {
        angular.module('kendo.directives').directive(widget, [
            'directiveFactory', function (directiveFactory)
            {
...
angular.module('kendo.directives').directive('kDataSource', [
    function ()
    {
