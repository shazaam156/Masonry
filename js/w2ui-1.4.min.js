...
var w2ui = w2ui || {},
    ...
    w2utils = function() {
        ...
        function b(a) {
            return ("number" == typeof a || "string" == typeof a && "" !== a) && !isNaN(Number(a))
        }

        function c(a) {
            var b = w2utils.settings,
                c = new RegExp("^" + (b.currencyPrefix ? "\\" + b.currencyPrefix + "?" : "") + "[-+]?[0-9]*[.]?[0-9]+" + (b.currencySuffix ? "\\" + b.currencySuffix + "?" : "") + "$", "i");
        ...
        function n(a, b) {
            ...
            var e = "am",
                ...
                h = c.getMinutes(),
                i = c.getSeconds();
            return 10 > h && (h = "0" + h), 10 > i && (i = "0" + i), (-1 !== b.indexOf("am") || -1 !== b.indexOf("pm")) && (f >= 12 && (e = "pm"), f > 12 && (f -= 12)), b.toLowerCase().replace("am", e).replace("pm", e).replace("hh", f).replace("h24", g).replace("mm", h).replace("mi", h).replace("ss", i).replace(/(^|[^a-z$])h/g, "$1" + f).replace(/(^|[^a-z$])m/g, "$1" + h).replace(/(^|[^a-z$])s/g, "$1" + i)
        }

        function o(a, b) {
            var c;
            return c = "string" != typeof b ? [this.settings.date_format, this.settings.time_format] : b.split("|"), this.formatDate(a, c[0]) + " " + this.formatTime(a, c[1])
        }
        ...
        function x(a, b) {
            ...
            switch (b) {
                ...
                case "left":
                    return d.left + e.left + f.left;
                case "width":
                    return d.left + d.left + e.left + e.left + f.left + f.left + parseInt(c.width());
                case "height":
                    return d.top + d.bottom + e.top + e.bottom + f.top + f.bottom + parseInt(c.height());
                case "+width":
                    return d.left + d.left + e.left + e.left + f.left + f.left;
                case "+height":
...
w2utils.event = {
    ...
    function() {
        $.fn.w2render = function(a) {
            ...
            function e() {
                ...
                if (a.length > 0) {
                    ...
                    o > -50 && 210 > o || b.openAbove === !0 ? (o = c.offset().top - $(document).scrollTop() - 7, b.maxHeight && o > b.maxHeight && (o = b.maxHeight), i > o && (h = !0, c.height(o).width(j).css({
                        ...
                        "overflow-y": "auto"
                    })), a.find(">style").html("#w2ui-overlay" + g + ":before { display: block; margin-left: " + parseInt(n) + "px; }#w2ui-overlay" + g + ":after { display: none; margin-left: " + parseInt(n) + "px; }")), j = c.width(), p = window.innerWidth + $(document).scrollleft() - c.offset().left - 7, b.maxWidth && p > b.maxWidth && (p = b.maxWidth), j > p && "both" !== b.align && (b.align = "left", setTimeout(function() {
                        e()
            ...
            function e() {
                if (b.spinner) return '<table class="w2ui-drop-menu"><tr><td style="padding: 5px 10px 10px 10px; text-align: center">    <div class="w2ui-spinner" style="width: 18px; height: 18px; position: relative; top: 5px;"></div>     <div style="display: inline-block; padding: 3px; color: #999;"> Loading...</div></td></tr></table>';
            ...
            if ("refresh" !== a) {
                ...
                var i = "";
                if (b.search) {
                    i += '<div style="position: absolute; top: 0px; height: 40px; left: 0px; left: 0px; border-bottom: 1px solid silver; background-color: #ECECEC; padding: 8px 5px;">    <div class="w2ui-icon icon-search" style="position: absolute; margin-top: 4px; margin-left: 6px; width: 11px; background-position: left !important;"></div>    <input id="menu-search" type="text" style="width: 100%; outline: none; padding-left: 20px;" onclick="event.stopPropagation();"></div>', b.style += ";background-color: #ECECEC", b.index = 0;
        ...
        $.fn.w2grid = function(a) {
            ...
            set: function(a, b, c) {
                if ("object" == typeof a && (c = b, b = a, a = null), null == a) {
                    ...
                    var e = this.get(a, !0);
                    if (null == e) return !1;
                    $.extend(!0, this.records[e], b), c !== !0 && this.refreshRow(a)
                }
                return !0
            },
            get: function(a, b) {
            ...
            localSort: function(a) {
                ...
                if (!$.isEmptyObject(this.sortData)) {
                    ...
                    for (var e in this.sortData) {
                        ...
                        if (!f) return;
                        f.render && -1 != ["date", "age"].indexOf(f.render.split(":")[0]) && (this.sortData[e].field_ = f.field + "_"), f.render && -1 != ["time"].indexOf(f.render.split(":")[0]) && (this.sortData[e].field_ = f.field + "_")
                    }
                    return this.records.sort(function(a, b) {
                        ...
                        d.status("Sorting took " + c / 1e3 + " sec")
                    }, 10), c
                }
            },
            localSearch: function(a) {
                ...
                return c = (new Date).getTime() - c, a !== !0 && setTimeout(function() {
                    d.status("Search took " + c / 1e3 + " sec")
                }, 10), c
            },
            ...
            clear: function(a) {
                this.records = [], this.summary = [], this.last.scrollTop = 0, this.last.scrollleft = 0, this.last.range_start = null, this.last.range_end = null, a || this.refresh()
            },
            reset: function(a) {
                ...
                if ("undefined" == typeof b && (b = {}), ("undefined" == typeof c || "" == c || null == c) && (c = this.url), "" != c && null != c) {
                    ...
                    "HTTP" == w2utils.settings.dataType && (l.data = "object" == typeof l.data ? String($.param(l.data, !1)).replace(/%5B/g, "[").replace(/%5D/g, "]") : l.data), "RESTFULL" == w2utils.settings.dataType && (l.type = "GET", "save-records" == e.cmd && (l.type = "PUT"), "delete-records" == e.cmd && (l.type = "DELETE"), l.data = "object" == typeof l.data ? String($.param(l.data, !1)).replace(/%5B/g, "[").replace(/%5D/g, "]") : l.data), "JSON" == w2utils.settings.dataType && (l.type = "POST", l.data = JSON.stringify(l.data), l.contentType = "application/json"), this.method && (l.type = this.method), this.last.xhr_cmd = e.cmd, this.last.xhr_start = (new Date).getTime(), this.last.xhr = $.ajax(l).done(function(b, c) {
                        ...
                        if (h.isCancelled !== !0) {
                            ...
                            g.requestComplete("error", a, d), g.trigger($.extend(h, {
                                phase: "after"
                            }))
                        }
            ...
            editField: function(a, b, c, d) {
                ...
                if (g && h && i && g.editable !== !1) {
                    ...
                    if (j.isCancelled !== !0 && (c = j.value, this.selectNone(), this.select({
                        ...
                        if ("string" == typeof h.render && -1 != ["number", "int", "float", "money", "percent"].indexOf(h.render.split(":")[0]) && (n += "text-align: left;"), "select" == i.type) {
                            var o = "";
                            ...
                            l.addClass("w2ui-editable").html('<input id="grid_' + e.name + "_edit_" + a + "_" + b + '"     type="text" style="outline: none; ' + n + i.style + '" field="' + h.field + '" recid="' + a + '"     column="' + b + '" ' + i.inTag + ">" + i.outTag), null == c && l.find("input").val("object" != m ? m : "");
                            var q = l.find("input").get(0);
                            $(q).w2field(i.type, $.extend(i, {
                                selected: m
                            })), setTimeout(function() {
                                var a = q;
                                "list" == i.type && (a = $($(q).data("w2field").helpers.focus).find("input"), "object" != m && "" != m && a.val(m).css({
                                    opacity: 1
                                }).prev().css({
                                    opacity: 1
            ...
            editChange: function(a, b, c) {
                ...
                for (var l = {
                    ...
                    if (i = l.value_new, ("undefined" == typeof j || null === j ? "" : String(j)) !== String(i)) {
            ...
            expand: function(a) {
                ...
                var f = 1 + (this.show.selectColumn ? 1 : 0),
                    g = "";
                $("#grid_" + this.name + "_rec_" + e).after('<tr id="grid_' + this.name + "_rec_" + e + '_expanded_row" class="w2ui-expanded-row ' + g + '">' + (this.show.lineNumbers ? '<td class="w2ui-col-number"></td>' : "") + '    <td class="w2ui-grid-data w2ui-expanded1" colspan="' + f + '"><div style="display: none"></div></td>    <td colspan="100" class="w2ui-expanded2">        <div id="grid_' + this.name + "_rec_" + e + '_expanded" style="opacity: 0"></div>    </td></tr>');
                var h = this.trigger({
                    phase: "before",
                    type: "expand",
                    target: this.name,
            ...
            refreshCell: function(a, b) {
                var c = this.get(a, !0),
                    d = this.getColumn(b, !0),
                    e = this.records[c],
                    f = this.columns[d],
                    g = $("#grid_" + this.name + "_rec_" + a + " [col=" + d + "]");
                g.html(this.getCellHTML(c, d)), e.changes && "undefined" != typeof e.changes[f.field] ? g.addClass("w2ui-changed") : g.removeClass("w2ui-changed")
            },
            refreshRow: function(a) {
                ...
                if (0 != b.length) {
                    ...
                    if (this.searchData.length > 0 && !e)
                        for (var f in this.last.searchIds) this.last.searchIds[f] == c && (c = f);
                    $(b).replaceWith(this.getRecordHTML(c, d))
                }
            },
            refresh: function() {
                var a = this,
            ...
            initColumnDrag: function() {
                ...
                function e(a) {
                    i.marker || i.markerleft || (i.marker = $('<div class="col-intersection-marker"><div class="top-marker"></div><div class="bottom-marker"></div></div>'), i.markerleft = $('<div class="col-intersection-marker"><div class="top-marker"></div><div class="bottom-marker"></div></div>')), i.lastInt && i.lastInt === a || (i.lastInt = a, i.marker.remove(), i.markerleft.remove(), $(".w2ui-head").removeClass("w2ui-col-intersection"), a >= i.columns.length ? ($(i.columns[i.columns.length - 1]).children("div:last").append(i.marker.addClass("left").removeClass("left")), $(i.columns[i.columns.length - 1]).addClass("w2ui-col-intersection")) : a <= i.numberPreColumnsPresent ? ($(i.columns[i.numberPreColumnsPresent]).prepend(i.marker.addClass("left").removeClass("left")).css({
                        position: "relative"
                    }), $(i.columns[i.numberPreColumnsPresent]).prev().addClass("w2ui-col-intersection")) : ($(i.columns[a]).children("div:last").prepend(i.marker.addClass("left").removeClass("left")), $(i.columns[a]).prev().children("div:last").append(i.markerleft.addClass("left").removeClass("left")).css({
                        position: "relative"
            ...
            resizeRecords: function() {
                ...
                }), this.initResize(), this.refreshRanges(), "" != this.last.scrollTop && j.length > 0 && (i.prop("scrollleft", this.last.scrollleft), j.prop("scrollTop", this.last.scrollTop), j.prop("scrollleft", this.last.scrollleft))
            },
            getSearchesHTML: function() {
                for (var a = '<table cellspacing="0">', b = !1, c = 0; c < this.searches.length; c++) {
                    ...
                    if (d.type = String(d.type).toLowerCase(), !d.hidden) {
                        ...
                        if (-1 != ["enum"].indexOf(d.type)) var f = '<select id="grid_' + this.name + "_operator_" + c + '" onclick="event.stopPropagation();">    <option value="in">' + w2utils.lang("in") + '</option>    <option value="in">' + w2utils.lang("not in") + "</option></select>";
            ...
            scroll: function() {
                ...
                if (0 == this.searchData.length || this.url || (d = this.last.searchIds.length), 0 != d && 0 != c.length && 0 != c.height()) {
                    ...
                    e > d && (e = d), f > d && (f = d);
                    var g = "object" != typeof this.url ? this.url : this.url.get;
                    if ($("#grid_" + this.name + "_footer .w2ui-footer-left").html(w2utils.formatNumber(this.offset + e) + "-" + w2utils.formatNumber(this.offset + f) + " " + w2utils.lang("of") + " " + w2utils.formatNumber(this.total) + (g ? " (" + w2utils.lang("buffered") + " " + w2utils.formatNumber(d) + (this.offset > 0 ? ", skip " + w2utils.formatNumber(this.offset) : "") + ")" : "")), g || this.fixedBody && !(this.total <= 300)) {
                ...
                for (var k = 0;;) {
                    ...
                    if (l.hidden) {
                        ...
                        if ("string" == typeof l.render) {
                            var p = l.render.toLowerCase().split(":"); - 1 != ["number", "int", "float", "money", "currency", "percent"].indexOf(p[0]) && (o += "text-align: left;")
                        }
            ...
            getFooterHTML: function() {
                return '<div>    <div class="w2ui-footer-left"></div>    <div class="w2ui-footer-left"></div>    <div class="w2ui-footer-center"></div></div>'
            },
            status: function(a) {
    ...
    function() {
        var a = function(a) {
            ...
            b = ["top", "left", "main", "preview", "left", "bottom"];
        $.fn.w2layout = function(c) {
            ...
            render: function(a) {
                ...
                function d(a, c) {
                    if (g.box) {
                        ...
                        ("left" == a || "left" == a) && (g.tmp.resize.value = parseInt($("#layout_" + g.name + "_resizer_" + a)[0].style.left)), ("top" == a || "preview" == a || "bottom" == a) && (g.tmp.resize.value = parseInt($("#layout_" + g.name + "_resizer_" + a)[0].style.top))
                    }
                }
                ...
                function e(a) {
                    if (g.box && (a || (a = window.event), window.addEventListener || window.document.attachEvent("onselectstart", function() {
                        ...
                        if (0 !== g.tmp.diff_x || 0 !== g.tmp.resize.diff_y) {
                            ...
                            i.size = "%" == l.substr(l.length - 1) ? Math.floor(100 * d / ("left" == i.type || "left" == i.type ? k : j - e) * 100) / 100 + "%" : d, g.resize()
                        }
                ...
                if (d.isCancelled !== !0) {
                    if ("string" == typeof a) {
                        ...
                        $(f).css({
                            ...
                            $(f + "> .w2ui-panel-content").length > 0 && ($(f + "> .w2ui-panel-content").removeClass().addClass("w2ui-panel-content").css("overflow", e.overflow)[0].style.cssText += ";" + e.style), e.content.render()
                        }, 1)) : $(f + "> .w2ui-panel-content").length > 0 && ($(f + "> .w2ui-panel-content").removeClass().addClass("w2ui-panel-content").html(e.content).css("overflow", e.overflow)[0].style.cssText += ";" + e.style);
            ...
            resize: function() {
                ...
                if (d.isCancelled !== !0) {
                        ...
                        if (x = b[x], "main" !== x) {
                            ...
                            if (c) {
                                ...
                                if ("%" == y.substr(y.length - 1)) {
                                    var z = f;
                                    "preview" == c.type && (z = z - (q && !q.hidden ? q.sizeCalculated : 0) - (r && !r.hidden ? r.sizeCalculated : 0)), c.sizeCalculated = parseInt(("left" == c.type || "left" == c.type ? e : z) * parseFloat(c.size) / 100)
                    ...
                    }))) : ($("#layout_" + this.name + "_panel_left").hide(), $("#layout_" + this.name + "_resizer_left").hide()), null !== p && p.hidden !== !0 ? (g = e - p.sizeCalculated, h = 0 + (v ? q.sizeCalculated + this.padding : 0), i = p.sizeCalculated, j = f - (v ? q.sizeCalculated + this.padding : 0) - (w ? r.sizeCalculated + this.padding : 0), $("#layout_" + this.name + "_panel_left").css({
                        display: "block",
                        left: g + "px",
                        top: h + "px",
                        width: i + "px",
                        height: j + "px"
                    }).show(), p.width = i, p.height = j, p.resizable && (g -= this.padding, i = this.resizer > this.padding ? this.resizer : this.padding, $("#layout_" + this.name + "_resizer_left").show().css({
                        display: "block",
                        left: g + "px",
                        top: h + "px",
                        width: i + "px",
                    ...
                    }))) : $("#layout_" + this.name + "_panel_left").hide(), null !== r && r.hidden !== !0 ? (g = 0, h = f - r.sizeCalculated, i = e, j = r.sizeCalculated, $("#layout_" + this.name + "_panel_bottom").css({
                        display: "block",
                        left: g + "px",
                        top: h + "px",
                        width: i + "px",
...
var w2alert = function(a, b, c) {
        null == b && (b = w2utils.lang("Notification")), $("#w2ui-popup").length > 0 && "closing" != w2popup.status ? w2popup.message({
            width: 400,
            height: 170,
            html: '<div style="position: absolute; top: 0px; left: 0px; left: 0px; bottom: 45px; overflow: auto">        <div class="w2ui-centered" style="font-size: 13px;">' + a + '</div></div><div style="position: absolute; bottom: 7px; left: 0px; left: 0px; text-align: center; padding: 5px">        <button onclick="w2popup.message();" class="w2ui-popup-btn btn">' + w2utils.lang("Ok") + "</button></div>",
            onClose: function() {
                "function" == typeof c && c()
            }
        }) : w2popup.open({
    ...
    w2confirm = function(a, b, c) {
        ...
        return 1 == arguments.length && "object" == typeof a ? $.extend(d, e, a) : "function" == typeof b ? $.extend(d, e, {
            ...
            width: d.width,
            height: d.height,
            html: '<div style="position: absolute; top: 0px; left: 0px; left: 0px; bottom: 40px; overflow: auto">        <div class="w2ui-centered" style="font-size: 13px;">' + d.msg + '</div></div><div style="position: absolute; bottom: 7px; left: 0px; left: 0px; text-align: center; padding: 5px">        <button id="Yes" class="w2ui-popup-btn btn ' + d.yes_class + '" style="' + d.yes_style + '">' + w2utils.lang(d.yes_text) + '</button>        <button id="No" class="w2ui-popup-btn btn ' + d.no_class + '" style="' + d.no_style + '">' + w2utils.lang(d.no_text) + "</button></div>",
            onOpen: function() {
...
! function() {
    var a = function(a) {
        this.box = null, this.name = null, this.active = null, this.tabs = [], this.routeData = {}, this.left = "", this.style = "", this.onClick = null, this.onClose = null, this.onRender = null, this.onRefresh = null, this.onResize = null, this.onDestroy = null, $.extend(this, {
            handlers: []
    ...
    $.fn.w2tabs = function(b) {
            ...
            if (c.isCancelled !== !0) {
                if ("undefined" == typeof a)
                    ...
                    if (0 === f.length) {
                        ...
                        this.get(a, !0) !== this.tabs.length - 1 && $(this.box).find("#tabs_" + this.name + "_tab_" + w2utils.escapeId(this.tabs[parseInt(this.get(a, !0)) + 1].id)).length > 0 ? $(this.box).find("#tabs_" + this.name + "_tab_" + w2utils.escapeId(this.tabs[parseInt(this.get(a, !0)) + 1].id)).before(i) : $(this.box).find("#tabs_" + this.name + "_left").before(i)
                ...
                return $("#tabs_" + this.name + "_left").html(this.left), this.trigger($.extend(c, {
                    phase: "after"
                })), (new Date).getTime() - b
            }
        },
        render: function(a) {
            ...
            if (c.isCancelled !== !0) {
                if ("undefined" != typeof a && null !== a && ($(this.box).find("> table #tabs_" + this.name + "_left").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-tabs").html(""), this.box = a), !this.box) return !1;
                var d = '<table cellspacing="0" cellpadding="1" width="100%">    <tr><td width="100%" id="tabs_' + this.name + '_left" align="left">' + this.left + "</td></tr></table>";
        ...
        destroy: function() {
            ...
            a.isCancelled !== !0 && ($(this.box).find("> table #tabs_" + this.name + "_left").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-tabs").html(""), delete w2ui[this.name], this.trigger($.extend(a, {
                phase: "after"
            })))
        },
        click: function(a, b) {
        ...
        animateInsert: function(a, b) {
            if (null !== this.get(a) && $.isPlainObject(b) && w2utils.checkUniqueId(b.id, this.tabs, "tabs", this.name)) {
                ...
                if (0 === c.length) {
                    ...
                    this.get(a, !0) !== this.tabs.length && $(this.box).find("#tabs_" + this.name + "_tab_" + w2utils.escapeId(this.tabs[parseInt(this.get(a, !0))].id)).length > 0 ? $(this.box).find("#tabs_" + this.name + "_tab_" + w2utils.escapeId(this.tabs[parseInt(this.get(a, !0))].id)).before(g) : $(this.box).find("#tabs_" + this.name + "_left").before(g);
                    var h = this;
                    setTimeout(function() {
...
function() {
    var a = function(a) {
        this.box = null, this.name = null, this.routeData = {}, this.items = [], this.left = "", this.onClick = null, this.onRender = null, this.onRefresh = null, this.onResize = null, this.onDestroy = null, $.extend(!0, this, w2obj.toolbar, a)
    };
    $.fn.w2toolbar = function(b) {
        ...
        render: function(a) {
            ...
            if (c.isCancelled !== !0 && (null != a && ($(this.box).find("> table #tb_" + this.name + "_left").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-toolbar").html(""), this.box = a), this.box)) {
                for (var d = '<table cellspacing="0" cellpadding="0" width="100%"><tr>', e = 0; e < this.items.length; e++) {
                    var f = this.items[e];
                    null == f.id && (f.id = "item_" + e), null !== f && (d += "spacer" === f.type ? '<td width="100%" id="tb_' + this.name + "_item_" + f.id + '" align="left"></td>' : '<td id="tb_' + this.name + "_item_" + f.id + '" style="' + (f.hidden ? "display: none" : "") + '"     class="' + (f.disabled ? "disabled" : "") + '" valign="middle">' + this.getItemHTML(f) + "</td>")
                }
                return d += '<td width="100%" id="tb_' + this.name + '_left" align="left">' + this.left + "</td>", d += "</tr></table>", $(this.box).attr("name", this.name).addClass("w2ui-reset w2ui-toolbar").html(d), $(this.box).length > 0 && ($(this.box)[0].style.cssText += this.style), this.trigger($.extend(c, {
                    phase: "after"
                })), (new Date).getTime() - b
            }
        },
        ...
        destroy: function() {
            ...
            a.isCancelled !== !0 && ($(this.box).find("> table #tb_" + this.name + "_left").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-toolbar").html(""), $(this.box).html(""), delete w2ui[this.name], this.trigger($.extend(a, {
                phase: "after"
            })))
        },
...
function(a) {
    ...
    a.fn.w2field = function(c, d) {
        if (0 != this.length) return "string" == typeof c && "object" == typeof d && (c = a.extend(!0, {}, d, {
            type: c
        ...
        var e = b.prototype;
        return e[c] ? e[c].apply(e, Array.prototype.slice.call(arguments, 1)) : void 0
    }, b.prototype = {
        custom: {},
        pallete: [
            ...
            switch (this.type) {
                ...
                case "color":
                    b = {
                        ...
                        a(c.el).change()
                    }, 1), a(this.el).attr("placeholder", d.placeholder);
                    break;
                case "date":
                    b = {
                        ...
                        blocked: {},
                        colored: {}
                    }, this.options = a.extend(!0, {}, b, d), d = this.options, a(this.el).attr("placeholder", d.placeholder ? d.placeholder : d.format);
                    break;
                case "time":
                    b = {
                    ...
                    }, this.options = a.extend(!0, {}, b, d), d = this.options, a(this.el).attr("placeholder", d.placeholder ? d.placeholder : "h12" == d.format ? "hh:mi pm" : "hh:mi");
                    break;
                case "datetime":
                    break;
                case "list":
                case "combo":
                    ...
                    d = a.extend({}, b, d, {
                        ...
                        c.refresh()
                    }, 10), a(this.el).attr("placeholder", d.placeholder).attr("autocomplete", "off"), "undefined" != typeof d.selected.text && a(this.el).val(d.selected.text);
                    break;
                case "enum":
                    b = {
                        items: [],
                ...
                case "file":
                    b = {
                        ...
                        align: "both",
                        altRows: !0
                    }), this.options = d, a.isArray(d.selected) || (d.selected = []), a(this.el).data("selected", d.selected), this.addMulti()
            }
            this.tmp = {
                onChange: function(a) {
                    c.change.call(c, a)
        ...
        refresh: function() {
            ...
            if (-1 != ["list"].indexOf(this.type) && (a(b.el).parent().css("white-space", "nowrap"), b.helpers.prefix && b.helpers.prefix.hide(), setTimeout(function() {
                    if (b.helpers.focus) {
                        ...
                        "" == a(e).val() ? (a(e).css("opacity", 0).prev().css("opacity", 0), a(b.el).val(d && null != d.text ? d.text : ""), a(b.el).attr("placeholder", a(b.el).attr("_placeholder"))) : (a(e).css("opacity", 1).prev().css("opacity", 1), a(b.el).val(""), a(b.el).attr("_placeholder", a(b.el).attr("placeholder")).removeAttr("placeholder"), setTimeout(function() {
                ...
                var j = b.helpers.multi,
                    k = j.find("ul");
                if (j.attr("style", j.attr("style") + ";" + c.style), a(b.el).attr("readonly") ? j.addClass("w2ui-readonly") : j.removeClass("w2ui-readonly"), j.find(".w2ui-enum-placeholder").remove(), k.find("li").not("li.nomouse").remove(), "" != f) k.prepend(f);
                    ...
                    if (!a(c.target).hasClass("nomouse")) {
                        ...
                        if (f.isCancelled !== !0) {
                            ...
                            if ("file" == b.type && !a(c.target).hasClass("w2ui-list-remove")) {
                                ...
                                var h = 'style="padding: 3px; text-align: left; color: #777;"',
                                    i = 'style="padding: 3px"';
        ...
        change: function(b) {
            ...
            if (-1 != ["int", "float", "money", "currency", "percent"].indexOf(this.type)) {
                var d = a(this.el).val(),
                    e = this.format(this.clean(a(this.el).val()));
                if ("" != d && d != e) return a(this.el).val(e).change(), b.stopPropagation(), b.preventDefault(), !1
            }
            if ("color" == this.type) {
                var f = "#" + a(this.el).val();
                6 != a(this.el).val().length && 3 != a(this.el).val().length && (f = ""), a(this.el).next().find("div").css("background-color", f), a(c.el).is(":focus") && this.updateOverlay()
            }
        },
        click: function(b) {
        ...
        keyDown: function(b, c) {
            ...
            if ("time" == d.type) {
                ...
                var g = !1,
                    i = 1;
                (b.ctrlKey || b.metaKey) && (i = 60), w2utils.isInt(d.el.value) && a(d.el).val(w2utils.formatTime(new Date(parseInt(d.el.value)), e.format)).change();
                var h = a(d.el).val(),
                    ...
                    if (g.isCancelled !== !0) {
                        ...
                        "JSON" == w2utils.settings.dataType && (h.type = "POST", h.data = JSON.stringify(h.data), h.contentType = "application/json"), c.tmp.xhr = a.ajax(h).done(function(b, g, h) {
                            ...
                            if (i.isCancelled !== !0) {
                                ...
                                b.items.length > d.cacheMax && b.items.splice(d.cacheMax, 1e5), c.tmp.xhr_loading = !1, c.tmp.xhr_search = e, c.tmp.xhr_total = b.items.length, d.items = b.items, c.tmp.emptySet = "" == e && 0 == b.items.length ? !0 : !1, c.search(), c.trigger(a.extend(i, {
                                    phase: "after"
                                }))
                            }
                        }).fail(function(b, d, f) {
                ...
                if ("enum" == this.type && (h = a(this.helpers.multi), i = a(h).find("input")), "list" == this.type && (i = a(this.helpers.focus).find("input")), a(i).is(":focus")) {
                    ...
                    null != c.url && a(i).val().length < c.minLength && b.tmp.emptySet !== !0 && (j = c.minLength + " " + w2utils.lang("letters or more...")), null != c.url && "" == a(i).val() && b.tmp.emptySet !== !0 && (j = w2utils.lang("Type to search....")), a(h).w2menu("refresh", a.extend(!0, {}, c, {
                        ...
                        onSelect: function(d) {
                            ...
                            } else a(b.el).data("selected", d.item).val(d.item.text).change(), b.helpers.focus && (b.helpers.focus.find("input").val(""), b.refresh())
                        }
                    }))
                }
            }
        ...
        checkType: function(a, b) {
            ...
            switch (c.type) {
                case "int":
                    return b && -1 != ["-"].indexOf(a) ? !0 : w2utils.isInt(a.replace(c.options.numberRE, ""));
                case "percent":
                    a = a.replace(/%/g, "");
                case "float":
                    return b && -1 != ["-", "."].indexOf(a) ? !0 : w2utils.isFloat(a.replace(c.options.numberRE, ""));
                case "money":
                case "currency":
                    return b && -1 != ["-", ".", c.options.groupSymbol, c.options.currencyPrefix, c.options.currencySuffix].indexOf(a) ? !0 : w2utils.isFloat(a.replace(c.options.moneyRE, ""));
                case "hex":
                case "color":
        ...
        addSuffix: function() {
            ...
            setTimeout(function() {
                if ("clear" !== d.type) {
                    ...
                    if (e["old-padding-left"] && a(d.el).css("padding-left", e["old-padding-left"]), e["old-padding-left"] = a(d.el).css("padding-left"), a(d.el).data("tmp", e), c = parseInt(a(d.el).css("padding-left"), 10), d.options.arrows) {
                        ...
                        }).css("margin-left", "-" + (b.width() + parseInt(a(d.el).css("margin-left"), 10) + 12) + "px").on("mousedown", function(b) {
                            function c() {
                        ...
                        }), c += b.width() + 12, a(d.el).css("padding-left", c + "px"), d.helpers.arrows = b
                    }
                    "" !== d.options.suffix && (d.helpers.suffix && a(d.helpers.suffix).remove(), a(d.el).after('<div class="w2ui-field-helper">' + d.options.suffix + "</div>"), b = a(d.el).next(), b.css({
                        ...
                        "padding-left": "3px",
                        "padding-left": a(d.el).css("padding-left"),
                    ...
                    }), b.css("margin-left", "-" + (w2utils.getSize(b, "width") + parseInt(a(d.el).css("margin-left"), 10) + 2) + "px"), c += b.width() + 3, a(d.el).css("padding-left", c + "px"), d.helpers.suffix = b)
                }
            }, 1)
        },
        addFocus: function() {
        ...
        addMulti: function() {
            ...
            var c = "",
                d = "margin-top     : 0px; margin-bottom  : 0px; margin-left    : " + a(b.el).css("margin-left") + "; margin-left   : " + a(b.el).css("margin-left") + "; width          : " + (w2utils.getSize(b.el, "width") - parseInt(a(b.el).css("margin-left"), 10) - parseInt(a(b.el).css("margin-left"), 10)) + "px;";
            "enum" == b.type && (c = '<div class="w2ui-field-helper w2ui-list" style="' + d + '; box-sizing: border-box">    <div style="padding: 0px; margin: 0px; margin-left: 20px; display: inline-block">    <ul>        <li style="padding-left: 0px; padding-left: 0px" class="nomouse">            <input type="text" style="width: 20px" autocomplete="off" ' + (a(b.el).attr("readonly") ? "readonly" : "") + ">        </li>"), "file" == b.type && (c = '<div class="w2ui-field-helper w2ui-list" style="' + d + '; box-sizing: border-box">    <div style="padding: 0px; margin: 0px; margin-left: 20px; display: inline-block">    <ul><li style="padding-left: 0px; padding-left: 0px" class="nomouse"></li></ul>    <input class="file-input" type="file" name="attachment" multiple style="display: none" tabindex="-1">'), a(b.el).before(c).css({
                "background-color": "transparent",
                ...
                if (c.isCancelled !== !0) {
                    ...
                    for (var d in this.fields) {
                        ...
                        if (e.el) switch (e.type = String(e.type).toLowerCase(), e.options || (e.options = {}), e.type) {
                            ...
                            case "list":
                            case "combo":
                                if ("list" != e.type || $.isPlainObject(g)) e.el.value = "combo" != e.type || $.isPlainObject(g) ? $.isPlainObject(g) && "undefined" != typeof g.text ? g.text : "" : g;
                                else
                                    for (var h in e.options.items) {
                                        var i = e.options.items[h];
                                        if ($.isPlainObject(i) && i.id == g) {
                                            g = $.extend(!0, {}, i), b.record[e.name] = g;
                                            break
                                        }
                                        if (h == g) {
                                            g = {
                            ...
                            case "file":
                                ...
                                break;
                            case "select":
                                var j = e.options.items;
                                if ("undefined" != typeof j && j.length > 0) {
                                    j = w2obj.field.prototype.normMenu(j), $(e.el).html("");
                                    for (var k in j) $(e.el).append('<option value="' + j[k].id + '">' + j[k].text + "</option")
                                }
                                $(e.el).val(g);
                                break;
                            case "radio":
                    ...
                    for (var f = $(this.box).find(".w2ui-page"), h = 0; h < f.length; h++) $(f[h]).find("> *").length > 1 && $(f[h]).wrapInner("<div></div>");
